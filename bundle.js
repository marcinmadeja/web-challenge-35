...
var dom = {
  header: $('.l-header'),
  logos_list: $('.s-logos__list'),
  nav: $('.l-nav__list'),
  scroll_text: $('.s-wwd__text'),
  slider: $('.h-slider'),
  testimonials_list: $('.testi__list'),
  responsiveBtn: $('.l-nav')
};
...
var SLIDER_API = function () {
  var progressInterval = 300;
  ...
  function updateProgress(element, progress, time) {
    ...
    var currentTime = progress + progressInterval;
  ...
  function startProgressBar(element, time) {
  ...
  function mainSliderInit() {
    var mainSliderLabels = ['intro', 'work', 'about', 'contacts'];

    _dom2.default.slider.slick({
      dots: true,
      arrows: false,
      autoplay: true,
      autoplaySpeed: 3000,
  ...
  return {
    mainSliderInit: mainSliderInit
  };
}(); /* global $ */
exports.default = SLIDER_API;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var PAGE_API = function () {
  function slickInit() {
    _slider2.default.mainSliderInit();

    _dom2.default.logos_list.slick({
      slidesToShow: 6,
      slidesToScroll: 1,
      autoplay: true,
      autoplaySpeed: 2000,
    ...
    _dom2.default.testimonials_list.slick();
  }

  function initResNavigationActions() {
    var btn = _dom2.default.responsiveBtn;
  ...
  function scrollbarInit() {
    _dom2.default.scroll_text.perfectScrollbar({
  ...
  function navFixed() {
    ...
    if (scroll >= 160) {
      _dom2.default.header.addClass('is_fixed');
    } else {
      _dom2.default.header.removeClass('is_fixed');
    }
  }
  ...
  function setActiveLink() {
    ...
    _dom2.default.nav.find('a').each(function () {
      var link = $(this);
      ...
      if (refElementTop < scrollPos + 15 && refElementTop + refElement.height() > scrollPos) {
        _dom2.default.header.find('a').removeClass('is_active');
  ...
  function setSmoothScrollingToAnchor() {
    $('a[href*="#"]:not([href="#"])').click(function () {
      if (location.pathname.replace(/^\//, '') === this.pathname.replace(/^\//, '') && location.hostname === this.hostname) {
        ...
        var navHeight = _dom2.default.header.height();
  ...
  function switchScrollBars() {
    var header = $('.s-wwd__item-header');
    var items = $('.s-wwd__item');

    header.on('click', function () {
      var item = $(this).closest('.s-wwd__item');
